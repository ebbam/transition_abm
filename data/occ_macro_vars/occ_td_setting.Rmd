...
# FULL OMN
  abm <- read.csv("/Users/ebbamark/Dropbox/GenerateOccMobNets/ONET/occ_names_employment_asec_occ_2010_soc_cw.csv") %>%
  ...
  # ONET
  abm <- read.csv("/Users/ebbamark/Dropbox/GenerateOccMobNets/ONET/acs_onet_2010_soc_cw.csv") %>% 
       rename(SOC2010 = soc_2010_code,
              OCC2010_desc = title) %>% 
