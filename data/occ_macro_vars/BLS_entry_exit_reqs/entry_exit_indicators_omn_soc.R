...
setdiff(unique(dat$SOC2010), unique(soc_all$SOC))
setdiff(unique(soc_all$SOC), unique(dat$SOC2010))


#soc_minor <- read.csv("/Users/ebbamark/Library/CloudStorage/OneDrive-Nexus365/GenerateOccMobNets/ONET/occ_names_employment_asec_soc_2010_minor_ipums_vars.csv")
soc_all <- read.csv("/Users/ebbamark/Library/CloudStorage/OneDrive-Nexus365/GenerateOccMobNets/data/soc_2010_codes_employment_asec.csv")
