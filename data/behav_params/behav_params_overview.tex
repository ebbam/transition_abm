...
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-28-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-29-1.pdf}}

\subsubsection{W. Wage Level Control}\label{w.-wage-level-control}

\begin{table}[t]
\caption{\label{tab:unnamed-chunk-30}Continuous UE Duration w. Wage Level Control} 
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lcccccccccccccccccccccccc}
\toprule
  & Cont. & Cont. (clipped) & Cont. w. UI & Cont. w. UI (clipped) & Cont. w. exhausted UI & Cont. w. exhausted UI (clipped) & Cont. Sq & Cont. Sq (clipped) & Cont. Sq w. UI & Cont. Sq w. UI (clipped) & Cont. Sq w. exhausted UI & Cont. Sq w. exhausted UI (clipped) & Cont. w. controls & Cont. w. controls (clipped) & Cont. w. UI w. controls & Cont. w. UI w. controls (clipped) & Cont. w. exhausted UI w. controls & Cont. w. exhausted UI w. controls (clipped) & Cont. Sq w. controls & Cont. Sq w. controls (clipped) & Cont. Sq w. UI w. controls & Cont. Sq w. UI w. controls (clipped) & Cont. Sq w. exhausted UI w. controls & Cont. Sq w. exhausted UI w. controls (clipped) \\ 
...
{\cellcolor[HTML]{ADD8E6}{Hourly Wage of Lost Job}} & {\cellcolor[HTML]{ADD8E6}{-0.009***}} & {\cellcolor[HTML]{ADD8E6}{-0.006***}} & {\cellcolor[HTML]{ADD8E6}{-0.009***}} & {\cellcolor[HTML]{ADD8E6}{-0.006***}} & {\cellcolor[HTML]{ADD8E6}{-0.009***}} & {\cellcolor[HTML]{ADD8E6}{-0.006***}} & {\cellcolor[HTML]{ADD8E6}{-0.009***}} & {\cellcolor[HTML]{ADD8E6}{-0.006***}} & {\cellcolor[HTML]{ADD8E6}{-0.009***}} & {\cellcolor[HTML]{ADD8E6}{-0.006***}} & {\cellcolor[HTML]{ADD8E6}{-0.009***}} & {\cellcolor[HTML]{ADD8E6}{-0.006***}} & {\cellcolor[HTML]{ADD8E6}{-0.011***}} & {\cellcolor[HTML]{ADD8E6}{-0.007***}} & {\cellcolor[HTML]{ADD8E6}{-0.011***}} & {\cellcolor[HTML]{ADD8E6}{-0.007***}} & {\cellcolor[HTML]{ADD8E6}{-0.011***}} & {\cellcolor[HTML]{ADD8E6}{-0.007***}} & {\cellcolor[HTML]{ADD8E6}{-0.011***}} & {\cellcolor[HTML]{ADD8E6}{-0.007***}} & {\cellcolor[HTML]{ADD8E6}{-0.011***}} & {\cellcolor[HTML]{ADD8E6}{-0.007***}} & {\cellcolor[HTML]{ADD8E6}{-0.011***}} & {\cellcolor[HTML]{ADD8E6}{-0.007***}} \\ 
...
\NormalTok{mod\_eb\_reweight2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}
  \AttributeTok{formula =}\NormalTok{ ratio\_wage }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dwmosun }\SpecialCharTok{+}\NormalTok{ dwmosun2 }\SpecialCharTok{+}\NormalTok{ female }\SpecialCharTok{+}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ white }\SpecialCharTok{+}\NormalTok{ black }\SpecialCharTok{+}\NormalTok{ mixed }\SpecialCharTok{+}\NormalTok{ marst }\SpecialCharTok{+}\NormalTok{ educ\_cat,}
  \AttributeTok{data =}\NormalTok{ df,}
  \AttributeTok{weights =}\NormalTok{ eb\_weight}
\NormalTok{)}

\NormalTok{mod\_eb\_reweight3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}
  \AttributeTok{formula =}\NormalTok{ ratio\_wage }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dwmosun }\SpecialCharTok{+}\NormalTok{ dwmosun2 }\SpecialCharTok{+}\NormalTok{ dwmosun3 }\SpecialCharTok{+}\NormalTok{ female }\SpecialCharTok{+}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ white }\SpecialCharTok{+}\NormalTok{ black }\SpecialCharTok{+}\NormalTok{ mixed }\SpecialCharTok{+}\NormalTok{ marst }\SpecialCharTok{+}\NormalTok{ educ\_cat,}
  \AttributeTok{data =}\NormalTok{ df,}
  \AttributeTok{weights =}\NormalTok{ eb\_weight}
\NormalTok{)}
...
\NormalTok{eb\_full }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{0}\SpecialCharTok{:}\NormalTok{(}\FunctionTok{nrow}\NormalTok{(eb\_full)}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{))) }\SpecialCharTok{+}
    ...
    \CommentTok{\# Model 3}
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ eb\_preds3\_fit), }\AttributeTok{color =} \StringTok{"firebrick"}\NormalTok{, }\AttributeTok{linewidth =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_ribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin =}\NormalTok{ eb\_preds3\_lwr, }\AttributeTok{ymax =}\NormalTok{ eb\_preds3\_upr), }\AttributeTok{fill =} \StringTok{"firebrick"}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.2}\NormalTok{) }\SpecialCharTok{+}
  
    \FunctionTok{labs}\NormalTok{(}
      \AttributeTok{title =} \StringTok{"Predicted Wage Ratios by Unemployment Duration"}\NormalTok{,}
      \AttributeTok{subtitle =} \StringTok{"From EB{-}weighted regressions: linear, quadratic, and cubic specifications"}\NormalTok{,}
      \AttributeTok{x =} \StringTok{"Unemployment Duration (months)"}\NormalTok{,}
      \AttributeTok{y =} \StringTok{"Predicted Wage Ratio"}
...
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-34-1.pdf}}
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-34-2.pdf}}
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-34-3.pdf}}
...
\NormalTok{)}
\NormalTok{mod\_glm\_reweight2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}
  \AttributeTok{formula =}\NormalTok{ ratio\_wage }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dwmosun }\SpecialCharTok{+}\NormalTok{ dwmosun2 }\SpecialCharTok{+}\NormalTok{ female }\SpecialCharTok{+}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ white }\SpecialCharTok{+}\NormalTok{ black }\SpecialCharTok{+}\NormalTok{ mixed }\SpecialCharTok{+}\NormalTok{ marst }\SpecialCharTok{+}\NormalTok{ educ\_cat,}
  \AttributeTok{data =}\NormalTok{ df,}
  \AttributeTok{weights =}\NormalTok{ glm\_weight}
\NormalTok{)}
\NormalTok{mod\_glm\_reweight3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}
  \AttributeTok{formula =}\NormalTok{ ratio\_wage }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dwmosun }\SpecialCharTok{+}\NormalTok{ dwmosun2 }\SpecialCharTok{+}\NormalTok{ dwmosun3 }\SpecialCharTok{+}\NormalTok{ female }\SpecialCharTok{+}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ white }\SpecialCharTok{+}\NormalTok{ black }\SpecialCharTok{+}\NormalTok{ mixed }\SpecialCharTok{+}\NormalTok{ marst }\SpecialCharTok{+}\NormalTok{ educ\_cat,}
  \AttributeTok{data =}\NormalTok{ df,}
  \AttributeTok{weights =}\NormalTok{ glm\_weight}
\NormalTok{)}
...
\NormalTok{glm\_full }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{0}\SpecialCharTok{:}\DecValTok{36}\NormalTok{)) }\SpecialCharTok{+}
    ...
    \CommentTok{\# Model 3}
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ glm\_preds3\_fit), }\AttributeTok{color =} \StringTok{"firebrick"}\NormalTok{, }\AttributeTok{linewidth =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_ribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin =}\NormalTok{ glm\_preds3\_lwr, }\AttributeTok{ymax =}\NormalTok{ glm\_preds3\_upr), }\AttributeTok{fill =} \StringTok{"firebrick"}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.2}\NormalTok{) }\SpecialCharTok{+}
  
    \FunctionTok{labs}\NormalTok{(}
      \AttributeTok{title =} \StringTok{"Predicted Wage Ratios by Unemployment Duration"}\NormalTok{,}
      \AttributeTok{subtitle =} \StringTok{"From GLM{-}weighted regressions: linear, quadratic, and cubic specifications"}\NormalTok{,}
      \AttributeTok{x =} \StringTok{"Unemployment Duration (months)"}\NormalTok{,}
      \AttributeTok{y =} \StringTok{"Predicted Wage Ratio"}
\NormalTok{    ) }\SpecialCharTok{+}
    \FunctionTok{theme\_minimal}\NormalTok{()}
...
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-36-1.pdf}}
...
\NormalTok{outcome\_eq2 }\OtherTok{\textless{}{-}}\NormalTok{ ratio\_wage }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dwmosun }\SpecialCharTok{+}\NormalTok{ dwmosun2 }\SpecialCharTok{+}\NormalTok{ female }\SpecialCharTok{+}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ white }\SpecialCharTok{+}\NormalTok{ black }\SpecialCharTok{+}\NormalTok{ mixed }\SpecialCharTok{+}\NormalTok{ marst }\SpecialCharTok{+}\NormalTok{ educ\_cat}
\NormalTok{outcome\_eq3 }\OtherTok{\textless{}{-}}\NormalTok{ ratio\_wage }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dwmosun }\SpecialCharTok{+}\NormalTok{ dwmosun2 }\SpecialCharTok{+}\NormalTok{ dwmosun3 }\SpecialCharTok{+}\NormalTok{ female }\SpecialCharTok{+}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ white }\SpecialCharTok{+}\NormalTok{ black }\SpecialCharTok{+}\NormalTok{ mixed }\SpecialCharTok{+}\NormalTok{ marst }\SpecialCharTok{+}\NormalTok{ educ\_cat }
...
\CommentTok{\# Run Heckman }
\NormalTok{heckman\_model2 }\OtherTok{\textless{}{-}} \FunctionTok{selection}\NormalTok{(}
  \AttributeTok{selection =}\NormalTok{ selection\_eq,}
  \AttributeTok{outcome =}\NormalTok{ outcome\_eq2,}
  \AttributeTok{data =}\NormalTok{ df,}
  \AttributeTok{method =} \StringTok{"2step"}\NormalTok{,       }
  \AttributeTok{weights =}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{dwsuppwt   }\CommentTok{\# Include weights from CPS}
\NormalTok{)}
...
\CommentTok{\# Run Heckman }
\NormalTok{heckman\_model3 }\OtherTok{\textless{}{-}} \FunctionTok{selection}\NormalTok{(}
  \AttributeTok{selection =}\NormalTok{ selection\_eq,}
  \AttributeTok{outcome =}\NormalTok{ outcome\_eq3,}
  \AttributeTok{data =}\NormalTok{ df,}
  \AttributeTok{method =} \StringTok{"2step"}\NormalTok{,       }
  \AttributeTok{weights =}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{dwsuppwt   }\CommentTok{\# Include weights from CPS}
\NormalTok{)}

\CommentTok{\# Predict ratio\_wage (corrected for selection)}
\NormalTok{preds }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(heckman\_model, }\AttributeTok{newdata =}\NormalTok{ newdata, }\AttributeTok{part =} \StringTok{"outcome"}\NormalTok{, }\AttributeTok{type =} \StringTok{"unconditional"}\NormalTok{)}
\NormalTok{preds2 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(heckman\_model2, }\AttributeTok{newdata =}\NormalTok{ newdata, }\AttributeTok{part =} \StringTok{"outcome"}\NormalTok{, }\AttributeTok{type =} \StringTok{"unconditional"}\NormalTok{)}
\NormalTok{preds3 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(heckman\_model3, }\AttributeTok{newdata =}\NormalTok{ newdata, }\AttributeTok{part =} \StringTok{"outcome"}\NormalTok{, }\AttributeTok{type =} \StringTok{"unconditional"}\NormalTok{)}


\CommentTok{\# Combine with original durations for plotting or inspection}
\NormalTok{newdata}\SpecialCharTok{$}\NormalTok{predicted\_ratio }\OtherTok{\textless{}{-}}\NormalTok{ preds}
\NormalTok{newdata}\SpecialCharTok{$}\NormalTok{predicted\_ratio2 }\OtherTok{\textless{}{-}}\NormalTok{ preds2}
\NormalTok{newdata}\SpecialCharTok{$}\NormalTok{predicted\_ratio3 }\OtherTok{\textless{}{-}}\NormalTok{ preds3}

\FunctionTok{ggplot}\NormalTok{(newdata, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ dwmosun)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ predicted\_ratio)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ predicted\_ratio2)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ predicted\_ratio3)) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Unemployment Duration (months)"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Predicted Wage Ratio"}\NormalTok{, }\AttributeTok{title =} \StringTok{"Predicted Wage Ratio vs. Unemployment Duration"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-37-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-39-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-40-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/unnamed-chunk-41-1.pdf}}
