...
linear interpretation of the bar graph) should be done carefully.
Preliminary results using the raw data are found in the next section.
...
\pandocbounded{\includegraphics[keepaspectratio]{behav_params_overview_files/figure-latex/cps_supp1-1.png}}
...
\(\beta_{1}\) as this is the main regression coefficient of interest.
...
\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/disc_reg1-2} \end{center}
...
\begin{table}
\centering\centering
\caption{\label{tab:disc_reg2}Continuous UE Duration w.o Wage Level Control}
\centering
...
\begin{table}
\centering\centering
\caption{\label{tab:disc_reg4}Continuous UE Duration w. Wage Level Control}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{lcccccccccccccccccccccccc}
\toprule
...
\begin{table}
\centering\centering
\caption{\label{tab:disc_reg5}Binned UE Duration w.o Wage Level Control}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
...
\begin{table}
\centering\centering
\caption{\label{tab:disc_reg6}Binned UE Duration w. Wage Level Control}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{lcccccccccccc}
\toprule
...
\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/disc_eb3-2} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/disc_eb4-1} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/disc_eb4-2} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/disc_eb5-1} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/disc_eb5-2} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/disc_glm2-2} \end{center}
...
\subsection{Mukoyama et al.~Job Search and the Business
Cycle}\label{mukoyama-et-al.-job-search-and-the-business-cycle}
...
We use evidence from Mukoyama et al regarding the cyclicality of
unemployed job search effort to validate the micro behaviour of our
agents. I will provide more explanation on this\ldots{}
...
\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/mukoyama-1} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/mukoyama-2} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/mukoyama-3} \end{center}

\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/mukoyama-4} \end{center}
