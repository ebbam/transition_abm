...
\section{A Calibrating Behavioural
Mechanisms}\label{a-calibrating-behavioural-mechanisms}
...
\subsection{Behavioural Mechanism
Calibration}\label{behavioural-mechanism-calibration}

\subsubsection{Application Effort and Learning Dynamics: Applications
...
\subsubsection{Wage Expectations and Satisficing: Reservation Wage
...
\begin{center}\includegraphics[width=0.9\linewidth]{behav_params_overview_files/figure-latex/disc_descriptives-5} \end{center}
