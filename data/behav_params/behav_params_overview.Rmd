...
2.  [Eeckhout et al. 2019 Unemployment
...
3.   [**Mueller et al. 2021: Job Seekers' Perceptions and Employment
...
1.*2018/2022 Bureau of Labor Statistics Supplement to the Current
Population Survey* which asks detailed questions about job search,
application effort, and unemployment duration to those who did not opt
in to unemployment insurance/compensation. 2. **Survey on Consumer
Expectations**: Which is a "nationallly representative" survey with a
Job Search Supplement conducted from 2014-2021.

I provide some preliminary detail on each of these options below
...
```{r, echo=FALSE, fig.height = 10, fig.width = 10, cache = TRUE}
...
# Predict
probs <- predict(best_model, newdata = new_data, type = "probs") 
