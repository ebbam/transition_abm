...
3.  Outline some considerations for further improvement of the analysis:
    ...
    2.  Representativeness of the data to motivate data limitations and inform the ultimate reweighting scheme.
...
wage <- df %>% 
  ...
  annotate("text",
    x = 36, y = 900, label = "Mean Hourly Wage (BLS Reported - 2024)",
    angle = 90,
    vjust = -0.5,
    size = 4,
    color = "red"
...
age <- df %>% 
  ...
  annotate("text",
    x = median_age, y = 300, label = "Median Reported Age",
    angle = 90,
    vjust = -0.5,
    #size = 4,
    color = "darkorchid4"
