...
bp3 <- df %>%
  ...
  geom_boxplot(aes(weight = dwsuppwt, fill = as.factor(dwwksun_bin)), alpha = 0.3)+
  geom_hline(yintercept = 1, color = "darkblue", linetype = "dashed") +
  labs(title = "Wage Ratio", y = "Accepted:Lost Wage Ratio", x = "Unemployment Duration") +
  common_theme +
  ylim(0,2.5) +
  theme(plot.title=element_text(hjust=0.5),
...
bp4 <- df %>%
  ...
  geom_boxplot(aes(weight = dwsuppwt, fill = as.factor(dwwksun_bin)), alpha = 0.3)+
  geom_hline(yintercept = 1, color = "darkblue", linetype = "dashed") +
  labs(title = "Wage Ratio - Reconciled with max") +
  common_theme + 
  ylim(0,2.5) +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_x_discrete(labels = labels)+
...
bp5 <- df %>%
  ...
  geom_boxplot(aes(weight = dwsuppwt, fill = as.factor(dwwksun_bin)), alpha = 0.3)+
  geom_hline(yintercept = 1, color = "darkblue", linetype = "dashed") +
  labs(title = "Wage Ratio - Reconciled with mean") +
  common_theme + 
  ylim(0,2.5) +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_x_discrete(labels = labels)+
...
(bp3 + bp4 + bp5) + plot_annotation(title = "Reported ratio of current wage to lost wage by unemployment duration", subtitle = "Observations weighted by Displaced Worker Supplement Weights. Annual data from 2000-2025. Exclude observations reporting > 96 weeks of unemployment.", theme = theme(plot.title = element_text(hjust = 0.5, size = 18), plot.subtitle = element_text(hjust = 0.5, size = 14)))

(bp3) + plot_annotation(title = "Reported ratio of current wage to lost wage by unemployment duration", subtitle = "Observations weighted by Displaced Worker Supplement Weights. Annual data from 2000-2025.\nExclude observations reporting > 96 weeks of unemployment.", theme = theme(plot.title = element_text(hjust = 0.5, size = 18), plot.subtitle = element_text(hjust = 0.5, size = 14)))

bp_cont + plot_annotation(title = "Reported ratio of current wage to lost wage by unemployment duration", subtitle = "Observations weighted by Displaced Worker Supplement Weights. Annual data from 2000-2025. Exclude observations reporting > 96 weeks of unemployment.", theme = theme(plot.title = element_text(hjust = 0.5, size = 18), plot.subtitle = element_text(hjust = 0.5, size = 10)))
...
output_pretty <- function(mods, highlightrows = FALSE, title = NULL){
  ...
  tab_style(
    ...
    tab_options(latex.table.width = "\\linewidth") %>%
    as_latex() %>%
    asis_output()
}
...
lm_full %>% 
  ggplot(aes(x = 0:(nrow(lm_full)-1))) +
    # Model 1
    geom_line(aes(y = lm_preds_fit), color = "blue", linewidth = 1) +
    geom_ribbon(aes(ymin = lm_preds_lwr, ymax = lm_preds_upr), fill = "blue", alpha = 0.2) +
  
    # Model 2
    geom_line(aes(y = lm_preds2_fit), color = "darkgreen", linewidth = 1) +
    geom_ribbon(aes(ymin = lm_preds2_lwr, ymax = lm_preds2_upr), fill = "darkgreen", alpha = 0.2) +
  
    # Model 3
    geom_line(aes(y = lm_preds3_fit), color = "firebrick", linewidth = 1) +
    geom_ribbon(aes(ymin = lm_preds3_lwr, ymax = lm_preds3_upr), fill = "firebrick", alpha = 0.2) +
...
eb_full %>% 
  ggplot(aes(x = 0:(nrow(eb_full)-1))) +
    # Model 1
    geom_line(aes(y = eb_preds_fit), color = "blue", linewidth = 1) +
    geom_ribbon(aes(ymin = eb_preds_lwr, ymax = eb_preds_upr), fill = "blue", alpha = 0.2) +
  
    # Model 2
    geom_line(aes(y = eb_preds2_fit), color = "darkgreen", linewidth = 1) +
    geom_ribbon(aes(ymin = eb_preds2_lwr, ymax = eb_preds2_upr), fill = "darkgreen", alpha = 0.2) +
  
    # Model 3
    geom_line(aes(y = eb_preds3_fit), color = "firebrick", linewidth = 1) +
    geom_ribbon(aes(ymin = eb_preds3_lwr, ymax = eb_preds3_upr), fill = "firebrick", alpha = 0.2) +
...
glm_full %>% 
  ggplot(aes(x = 0:36)) +
    # Model 1
    geom_line(aes(y = glm_preds_fit), color = "blue", linewidth = 1) +
    geom_ribbon(aes(ymin = glm_preds_lwr, ymax = glm_preds_upr), fill = "blue", alpha = 0.2) +
  
    # Model 2
    geom_line(aes(y = glm_preds2_fit), color = "darkgreen", linewidth = 1) +
    geom_ribbon(aes(ymin = glm_preds2_lwr, ymax = glm_preds2_upr), fill = "darkgreen", alpha = 0.2) +
  
    # Model 3
    geom_line(aes(y = glm_preds3_fit), color = "firebrick", linewidth = 1) +
    geom_ribbon(aes(ymin = glm_preds3_lwr, ymax = glm_preds3_upr), fill = "firebrick", alpha = 0.2) +
...
ggplot(newdata, aes(x = dwmosun)) +
  geom_line(aes(y = predicted_ratio)) +
  geom_line(aes(y = predicted_ratio2)) +
  geom_line(aes(y = predicted_ratio3)) +
...
ggplot() + 
  geom_line(data = lm_full, aes(x = 0:36, y = lm_preds_fit), color = "blue") +
  geom_ribbon(data = lm_full, aes(x = 0:36, ymin = lm_preds_lwr, ymax = lm_preds_upr), fill = "blue", alpha = 0.2) +
  geom_line(data = glm_full, aes(x = 0:36, y = glm_preds_fit), color = "red") +
  geom_ribbon(data = glm_full, aes(x = 0:36, ymin = glm_preds_lwr, ymax = glm_preds_upr), fill = "red", alpha = 0.2) +
  geom_line(data = eb_full, aes(x = 0:36, y = eb_preds_fit), color = "darkgreen") +
  geom_ribbon(data = eb_full, aes(x = 0:36, ymin = eb_preds_lwr, ymax = eb_preds_upr), fill = "darkgreen", alpha = 0.2) +
