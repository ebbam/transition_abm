...
(lin + spline) + plot_annotation(title = "Linear and spline fit to scatter plot of wage ratio vs. unemployment duration in months.", subtitle = "Observations weighted by Displaced Worker Supplement Weights. Annual data from 2000-2025. Exclude observations reporting > 96 weeks of unemployment and wage ratios below 0.5 and above 2.", theme = plot_annotation_theme)
...
```{r disc_eb3, echo = FALSE, warning = FALSE}
...
```{r disc_eb4, echo = FALSE, warning = FALSE}
...
```{r disc_eb5, echo = FALSE, warning = FALSE}
