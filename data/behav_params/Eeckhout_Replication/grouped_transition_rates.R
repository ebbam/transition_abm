...
if(new_data)
  ...
  p1 <- all_rates %>%
    ...
    geom_line() +
    labs(color = "Age", x = "Date", y = "E-E Transition Rate (E-E Transitions/Employed)") +
    common_theme +
  ...
  p1 + plot_annotation(title = "EE Transition Rate by Age Group", subtitle = "Data: Current Population Survey")
