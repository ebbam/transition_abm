...
#   # Unfortunately...the raw data does not contain the time??? not sure where that comes from...
...
# #sce <- sce[, colnames(old)]
# #test_equal(full = TRUE, verbose = TRUE)
# #all.equal(sce, old, check.attributes = FALSE)
# 
# # Save Data
# #saveRDS(sce, here("data/behav_params/Mueller_Replication/sce_datafile_em_2025.RDS"))
...
ready = FALSE
if(ready){
  cleaning_function(sce_13_19_same_t, save = TRUE, file_name = "sce_datafile_13_19_constrained_to_orig")
  cleaning_function(sce_13_19, save = TRUE, file_name = "sce_datafile_13_19")
  cleaning_function(sce_13_24, save = TRUE, file_name = "sce_datafile_13_24")
  cleaning_function(sce_20_24, save = TRUE, file_name = "sce_datafile_20_24")
}
