...
unrate = pd.read_csv("data/macro_vars/UNRATE.csv", delimiter=',', decimal='.')
...
jorate = pd.read_csv("data/macro_vars/JTSJOR.csv", delimiter=',', decimal='.')
...
realgdp = pd.read_csv("data/macro_vars/GDPC1.csv", delimiter=',', decimal='.')
...
f_unrate = pd.read_csv("data/macro_vars/LNS14000002.csv", delimiter=',', decimal='.')
...
m_unrate = pd.read_csv("data/macro_vars/LNS14000001.csv", delimiter=',', decimal='.')
...
ltuer = pd.read_csv("data/macro_vars/LNS13025703.csv", delimiter=',', decimal='.')
...
macro_observations.to_csv( "data/macro_vars/collated_macro_observations.csv")
...
recessions = pd.read_csv("data/macro_vars/USREC.csv", delimiter=',', decimal='.')
recessions["DATE"] = pd.to_datetime(recessions["DATE"])

recessions.to_csv( "data/macro_vars/collated_recessions.csv")
...
seps = pd.read_csv("data/macro_vars/JTSTSR.csv", delimiter=',', decimal='.')
...
quits = pd.read_csv("data/macro_vars/JTSQUR.csv", delimiter=',', decimal='.')
...
hires = pd.read_csv("data/macro_vars/JTSHIR.csv", delimiter=',', decimal='.')
...
layoffs = pd.read_csv("data/macro_vars/JTSLDR.csv", delimiter=',', decimal='.')
...
jolts.to_csv( "data/macro_vars/collated_jolts.csv")
...
jobopenings = pd.read_csv("data/macro_vars/JTSJOL.csv", delimiter=',', decimal='.')
...
emp_real = pd.read_csv("data/macro_vars/PAYEMS.csv", delimiter=',', decimal='.')
...
#t_demand_real.to_csv( "data/macro_vars/collated_t_demand_real.csv")


#### GDP GROWTH RATE ####
gdp_growth = pd.read_csv("data/macro_vars/GDPC1_pct_ch.csv", delimiter=',', decimal='.')
...
bus_conf = pd.read_csv( "data/macro_vars/OECD_bus_conf_usa.csv")
