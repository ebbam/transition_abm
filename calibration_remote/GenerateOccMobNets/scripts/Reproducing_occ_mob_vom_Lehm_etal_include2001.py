...
year_start = 2001
year_end = 2019 # rep goes to 2018
...
plt.plot([y for y in range(year_start, year_end)], mobility_50codes_with_imp, "o-")
...
plt.plot([y for y in range(year_start, year_end)], mobility_50codes_wo_imp, "o-")
plt.ylabel("occupational mobility rate")
plt.title("occupational mobility using unharmonized 2010 codes")
plt.show()


plt.plot([y for y in range(year_start, year_end)], mobility_50codes_with_imp, "--")
plt.plot([y for y in range(year_start, year_end)],  mobility_50codes_wo_imp, "-")
...
print("Average occupational mobility without corrections, ", np.mean(mobility_50codes_wo_imp))
print("Average occupational mobility with corrections, ", 1.55*(np.mean(mobility_50codes_wo_imp)))
